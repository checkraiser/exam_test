...
class EnrollmentsControllerTest < ActionController::TestCase
  ...
  test "should create enrollment" do
    assert_difference('Enrollment.count') do
      post :create, enrollment: { course_id: @enrollment.course_id, role: @enrollment.role, user_id: @enrollment.user_id }
    end
  ...
  test "should update enrollment" do
    patch :update, id: @enrollment, enrollment: { course_id: @enrollment.course_id, role: @enrollment.role, user_id: @enrollment.user_id }
    assert_redirected_to enrollment_path(assigns(:enrollment))
  end
